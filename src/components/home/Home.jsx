...
function Home() {
  return (
    <div className="h-screen flex justify-center items-center bg-slate-950 relative overflow-hidden">
      <div
        className="absolute items-center-safe  h-[200px] w-[800px] bg-center filter blur-[150px]"
